...
<template>
  <div class="min-h-dvh bg-white dark:bg-black text-gray-900 dark:text-white transition-colors duration-300">
    ...
    <div class="max-w-5xl mx-auto pt-12 px-6 flex justify-between items-end mb-6">
      ...
      <div class="flex items-center gap-3">
        ...
        <button 
          ...
          class="group flex items-center gap-3 px-5 py-2.5 rounded-2xl border border-gray-100 dark:border-gray-800 hover:border-orange-600/50 hover:bg-orange-50/50 dark:hover:bg-orange-950/10 transition-all active:scale-95 shadow-sm"
        >
    ...
    <div class="max-w-5xl mx-auto px-6">
      <div class="bg-gray-50 dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-[3rem] p-12 shadow-sm transition-all duration-500">
    ...
    <!-- List Spacer -->
    <div class="max-w-5xl mx-auto h-8"></div>

    <!-- History List -->
    <div class="max-w-5xl mx-auto py-4 px-6 pb-32">
      ...
      <div v-else class="space-y-3">
        ...
        >
          ...
          <div 
            ...
            class="flex-1 bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-[2rem] py-4 px-6 flex flex-wrap items-center justify-between gap-4 hover:border-orange-600/50 hover:shadow-xl hover:shadow-orange-900/5 transition-all shadow-sm cursor-pointer active:scale-[0.99]"
