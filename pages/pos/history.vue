          ...
          <div class="flex-1 min-w-[200px]">
            <div class="flex flex-wrap gap-2">
              <div 
                ...
                :key="item.id"
                class="bg-gray-50 dark:bg-gray-800 px-3 py-1.5 rounded-xl text-[10px] font-black uppercase tracking-tight flex items-center gap-2 text-gray-700 dark:text-gray-300"
              >
