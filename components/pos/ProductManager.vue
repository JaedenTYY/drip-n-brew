  ...
  <div class="space-y-8">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
      <div 
        ...
        :key="product.id"
        class="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-2xl p-4 flex items-center gap-4 group hover:border-orange-500/50 transition-all"
      >
        <div class="h-16 w-16 rounded-xl bg-gray-100 dark:bg-gray-800 overflow-hidden flex-shrink-0 border border-gray-200 dark:border-gray-700">
        ...
        <div class="flex-1">
          <div class="flex items-center gap-2">
            <h3 class="font-black uppercase tracking-tight text-gray-900 dark:text-white">{{ product.name }}</h3>
        ...
        <div class="flex items-center gap-2">
          ...
          <button @click="handleEdit(product)" class="p-2 text-gray-400 hover:text-gray-900 dark:hover:text-white transition-colors">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
            </svg>
          </button>

          <button @click="deleteProduct(product.id)" class="p-2 text-gray-400 dark:text-gray-600 hover:text-red-500 transition-colors">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
