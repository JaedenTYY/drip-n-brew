          ...
          <div class="flex flex-col gap-1">
            <div class="flex items-center gap-2 flex-wrap">
              ...
              <div class="flex gap-1 flex-wrap">
                <span v-for="cat in product.categories" :key="cat" class="text-[8px] font-black bg-gray-100 dark:bg-gray-800 text-gray-500 px-2 py-0.5 rounded-full uppercase">{{ cat }}</span>
              </div>
            </div>
